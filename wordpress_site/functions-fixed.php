...
function fds_theme_scripts() {
    ...
    // Clean header CSS
    wp_enqueue_style(
        'fds-clean-header-css',
        FDS_THEME_URI . '/fds-clean-header.css',
        array(),
        FDS_THEME_VERSION
    );
    
    // Ultra-clean pages CSS
    wp_enqueue_style(
        'fds-ultra-clean-pages-css',
        FDS_THEME_URI . '/fds-ultra-clean-pages.css',
        array(),
        FDS_THEME_VERSION
    );
    ...
    // Engaging styles CSS
    wp_enqueue_style(
        'fds-engaging-styles-css',
        FDS_THEME_URI . '/fds-engaging-styles.css',
        array(),
        FDS_THEME_VERSION
    );
    
    // Services page specific CSS
    if (is_page('our-services') || is_page('services')) {
        wp_enqueue_style(
            'fds-services-page-css',
            FDS_THEME_URI . '/services-page-styles.css',
            array(),
            FDS_THEME_VERSION
        );
    }
    ...
    wp_enqueue_script(
        'fds-clean-header-js',
        FDS_THEME_URI . '/fds-clean-header.js',
        array(),
        FDS_THEME_VERSION,
        true
    );
